...
#endif
#ifdef CORE_N64
namespace ares::Nintendo64 { auto load(Node::System& node, string name) -> bool; }
#endif
#ifdef CORE_NG
...
auto defaultProfileForMedium(const string& medium, const string& region) -> string {
  ...
  if(medium == "Game Boy Advance") return string{"[Nintendo] Game Boy Advance"};
