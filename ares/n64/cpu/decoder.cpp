...
#define LoadToGpr                         Load, MayException, MayFault, WritesGpSpRt
#define StoreToGpr                        Store, MayException, MayFault, WritesGpSpRt
#define FPUCall                           Cop1, MayException
#define FPUBranchCall                     \
  Cop1, Branch, EndBlock, MayException
#define FPUInvalid                        Cop1, IsInvalid, EndBlock, MayException
#define COP2Call                          Cop2, MayException
#define COP2Invalid                       Cop2, IsInvalid, EndBlock, MayException
...
auto CPU::decoderEXECUTEInfo(u32 instruction) const -> OpInfo {
  ...
  jp(0x11, FPU);
  jp(0x12, COP2);
  op(0x13, COP3, IsInvalid, EndBlock, MayException);
  ...
  op(0x1a, LDL, Load, MayException, MayFault, WritesGpSpRt);
  op(0x1b, LDR, Load, MayException, MayFault, WritesGpSpRt);
  op(0x1c, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1d, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1e, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1f, INVALID, IsInvalid, EndBlock, MayException);
  op(0x20, LB, LoadToGpr);
  op(0x21, LH, LoadToGpr);
  op(0x22, LWL, Load, MayException, MayFault, WritesGpSpRt);
  op(0x23, LW, LoadToGpr);
  op(0x24, LBU, LoadToGpr);
  op(0x25, LHU, LoadToGpr);
  op(0x26, LWR, Load, MayException, MayFault, WritesGpSpRt);
  op(0x27, LWU, LoadToGpr);
  op(0x28, SB, Store, MayException, MayFault);
  op(0x29, SH, Store, MayException, MayFault);
  op(0x2a, SWL, Store, MayException, MayFault);
  op(0x2b, SW, Store, MayException, MayFault);
  op(0x2c, SDL, Store, MayException, MayFault);
  op(0x2d, SDR, Store, MayException, MayFault);
  op(0x2e, SWR, Store, MayException, MayFault);
  op(0x2f, CACHE, Store, MayException, MayFault);
  op(0x30, LL, LoadToGpr);
  op(0x31, LWC1, Load, MayException, MayFault);
  op(0x32, LWC2, IsInvalid, EndBlock, MayException);
  op(0x33, LWC3, IsInvalid, EndBlock, MayException);
  op(0x34, LLD, LoadToGpr);
  op(0x35, LDC1, Load, MayException, MayFault);
  op(0x36, LDC2, IsInvalid, EndBlock, MayException);
  op(0x37, LD, LoadToGpr);
  op(0x38, SC, StoreToGpr);
  op(0x39, SWC1, Store, MayException, MayFault);
  op(0x3a, SWC2, IsInvalid, EndBlock, MayException);
  op(0x3b, SWC3, IsInvalid, EndBlock, MayException);
  op(0x3c, SCD, StoreToGpr);
  op(0x3d, SDC1, Store, MayException, MayFault);
  op(0x3e, SDC2, IsInvalid, EndBlock, MayException);
  op(0x3f, SD, Store, MayException, MayFault);
  }
  return {};
}
...
auto CPU::decoderSPECIALInfo(u32 instruction) const -> OpInfo {
  ...
  op(0x01, INVALID, IsInvalid, EndBlock, MayException);
  op(0x02, SRL, WritesGpSpRd);
  op(0x03, SRA, WritesGpSpRd);
  op(0x04, SLLV, WritesGpSpRd);
  op(0x05, INVALID, IsInvalid, EndBlock, MayException);
  op(0x06, SRLV, WritesGpSpRd);
  op(0x07, SRAV, WritesGpSpRd);
  op(0x08, JR, Branch, EndBlock);
  op(0x09, JALR, Branch, EndBlock, WritesGpSpRd);
  op(0x0a, INVALID, IsInvalid, EndBlock, MayException);
  op(0x0b, INVALID, IsInvalid, EndBlock, MayException);
  op(0x0c, SYSCALL, EndBlock, MayException);
  op(0x0d, BREAK, EndBlock, MayException);
  op(0x0e, INVALID, IsInvalid, EndBlock, MayException);
  op(0x0f, SYNC);
  ...
  op(0x15, INVALID, IsInvalid, EndBlock, MayException);
  ...
  op(0x28, INVALID, IsInvalid, EndBlock, MayException);
  op(0x29, INVALID, IsInvalid, EndBlock, MayException);
  ...
  op(0x35, INVALID, IsInvalid, EndBlock, MayException);
  op(0x36, TNE, MayTrap, MayException);
  op(0x37, INVALID, IsInvalid, EndBlock, MayException);
  op(0x38, DSLL, WritesGpSpRd);
  op(0x39, INVALID, IsInvalid, EndBlock, MayException);
  op(0x3a, DSRL, WritesGpSpRd);
  op(0x3b, DSRA, WritesGpSpRd);
  op(0x3c, DSLL32, WritesGpSpRd);
  op(0x3d, INVALID, IsInvalid, EndBlock, MayException);
...
auto CPU::decoderREGIMMInfo(u32 instruction) const -> OpInfo {
  ...
  op(0x04, INVALID, IsInvalid, EndBlock, MayException);
  op(0x05, INVALID, IsInvalid, EndBlock, MayException);
  op(0x06, INVALID, IsInvalid, EndBlock, MayException);
  op(0x07, INVALID, IsInvalid, EndBlock, MayException);
  ...
  op(0x0d, INVALID, IsInvalid, EndBlock, MayException);
  op(0x0e, TNEI, MayTrap, MayException);
  op(0x0f, INVALID, IsInvalid, EndBlock, MayException);
  ...
  op(0x14, INVALID, IsInvalid, EndBlock, MayException);
  op(0x15, INVALID, IsInvalid, EndBlock, MayException);
  op(0x16, INVALID, IsInvalid, EndBlock, MayException);
  op(0x17, INVALID, IsInvalid, EndBlock, MayException);
  op(0x18, INVALID, IsInvalid, EndBlock, MayException);
  op(0x19, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1a, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1b, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1c, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1d, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1e, INVALID, IsInvalid, EndBlock, MayException);
  op(0x1f, INVALID, IsInvalid, EndBlock, MayException);
...
auto CPU::decoderSCCInfo(u32 instruction) const -> OpInfo {
  ...
  op(0x00, MFC0, Cop0, Privileged, MayException, WritesGpSpRt);
  op(0x01, DMFC0, Cop0, Privileged, MayException, WritesGpSpRt);
  op(0x02, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x03, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x04, MTC0, Cop0, Privileged, MayException,
     JitStateKeyMayChange);
  op(0x05, DMTC0, Cop0, Privileged, MayException,
     JitStateKeyMayChange);
  op(0x06, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x07, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x08, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x09, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0a, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0b, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0c, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0d, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0e, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  op(0x0f, INVALID, Cop0, Privileged, IsInvalid, EndBlock, MayException);
  }

  switch(instruction & 0x3f) {
  op(0x01, TLBR, Cop0, Privileged, MayException);
  op(0x02, TLBWI, Cop0, Privileged, MayException);
  op(0x06, TLBWR, Cop0, Privileged, MayException);
  op(0x08, TLBP, Cop0, Privileged, MayException);
  op(0x18, ERET, Cop0, Privileged, EndBlock, MayException,
     JitStateKeyMayChange);
  op(0x20, XDETECT);
  op(0x25, XLOG);
  op(0x27, XHEXDUMP);
  op(0x28, XPROF);
  op(0x29, XPROFREAD);
  op(0x2a, XEXCEPTION, MayException);
  op(0x2c, XIOCTL);
  }
