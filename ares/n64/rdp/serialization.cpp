auto RDP::serialize(serializer& s) -> void {
  ...
  s(combine.mul.color[0]);
  s(combine.mul.color[1]);
  s(combine.mul.alpha[0]);
  s(combine.mul.alpha[1]);
  s(combine.add.color[0]);
  s(combine.add.color[1]);
  s(combine.add.alpha[0]);
  s(combine.add.alpha[1]);
  s(combine.sba.color[0]);
  s(combine.sba.color[1]);
  s(combine.sba.alpha[0]);
  s(combine.sba.alpha[1]);
  s(combine.sbb.color[0]);
  s(combine.sbb.color[1]);
  s(combine.sbb.alpha[0]);
  s(combine.sbb.alpha[1]);
