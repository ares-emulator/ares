...
struct Platform {
  ...
  virtual auto emulatedProgressHint(u64 emulatedUnits, u64 unitsPerSecond) -> void {}
  //Actual game FPS (not video refreshes). Call this whenever a *new* game frame
  //is generated by the game (instead of at every video hardware refresh). This allows to provide
  //an estimation of the actual in-game frame rate (which can be lower than the refresh rate). 
  virtual auto gameFrameHint() -> void {}
