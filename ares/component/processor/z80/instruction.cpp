auto Z80::instruction() -> void {
  ...
  if(code == 0xcb && prefix != Prefix::hl) {
    WZ = HL + (i8)operand();
    n8 opcd = operand(); // pseudo opcode fetch (3 cycles)
    wait(2);
  //R is not incremented here
    instructionCBd(WZ, opcd);
  } else if(code == 0xcb) {
    R.bit(0,6)++;
...
auto Z80::instructionCBd(n16 addr, n8 code) -> void {
  ...
  op(0x04, RLC_irr_r, addr, _H)
  op(0x05, RLC_irr_r, addr, _L)
  ...
  op(0x0c, RRC_irr_r, addr, _H)
  op(0x0d, RRC_irr_r, addr, _L)
  ...
  op(0x14, RL_irr_r, addr, _H)
  op(0x15, RL_irr_r, addr, _L)
  ...
  op(0x1c, RR_irr_r, addr, _H)
  op(0x1d, RR_irr_r, addr, _L)
  ...
  op(0x24, SLA_irr_r, addr, _H)
  op(0x25, SLA_irr_r, addr, _L)
  ...
  op(0x2c, SRA_irr_r, addr, _H)
  op(0x2d, SRA_irr_r, addr, _L)
  ...
  op(0x34, SLL_irr_r, addr, _H)
  op(0x35, SLL_irr_r, addr, _L)
  ...
  op(0x3c, SRL_irr_r, addr, _H)
  op(0x3d, SRL_irr_r, addr, _L)
  op(0x3e, SRL_irr_r, addr, _)
  op(0x3f, SRL_irr_r, addr, A)
  op(0x40, BIT_o_irr_r, 0, addr, _)
  op(0x41, BIT_o_irr_r, 0, addr, _)
  op(0x42, BIT_o_irr_r, 0, addr, _)
  op(0x43, BIT_o_irr_r, 0, addr, _)
  op(0x44, BIT_o_irr_r, 0, addr, _)
  op(0x45, BIT_o_irr_r, 0, addr, _)
  op(0x46, BIT_o_irr_r, 0, addr, _)
  op(0x47, BIT_o_irr_r, 0, addr, _)
  op(0x48, BIT_o_irr_r, 1, addr, _)
  op(0x49, BIT_o_irr_r, 1, addr, _)
  op(0x4a, BIT_o_irr_r, 1, addr, _)
  op(0x4b, BIT_o_irr_r, 1, addr, _)
  op(0x4c, BIT_o_irr_r, 1, addr, _)
  op(0x4d, BIT_o_irr_r, 1, addr, _)
  op(0x4e, BIT_o_irr_r, 1, addr, _)
  op(0x4f, BIT_o_irr_r, 1, addr, _)
  op(0x50, BIT_o_irr_r, 2, addr, _)
  op(0x51, BIT_o_irr_r, 2, addr, _)
  op(0x52, BIT_o_irr_r, 2, addr, _)
  op(0x53, BIT_o_irr_r, 2, addr, _)
  op(0x54, BIT_o_irr_r, 2, addr, _)
  op(0x55, BIT_o_irr_r, 2, addr, _)
  op(0x56, BIT_o_irr_r, 2, addr, _)
  op(0x57, BIT_o_irr_r, 2, addr, _)
  op(0x58, BIT_o_irr_r, 3, addr, _)
  op(0x59, BIT_o_irr_r, 3, addr, _)
  op(0x5a, BIT_o_irr_r, 3, addr, _)
  op(0x5b, BIT_o_irr_r, 3, addr, _)
  op(0x5c, BIT_o_irr_r, 3, addr, _)
  op(0x5d, BIT_o_irr_r, 3, addr, _)
  op(0x5e, BIT_o_irr_r, 3, addr, _)
  op(0x5f, BIT_o_irr_r, 3, addr, _)
  op(0x60, BIT_o_irr_r, 4, addr, _)
  op(0x61, BIT_o_irr_r, 4, addr, _)
  op(0x62, BIT_o_irr_r, 4, addr, _)
  op(0x63, BIT_o_irr_r, 4, addr, _)
  op(0x64, BIT_o_irr_r, 4, addr, _)
  op(0x65, BIT_o_irr_r, 4, addr, _)
  op(0x66, BIT_o_irr_r, 4, addr, _)
  op(0x67, BIT_o_irr_r, 4, addr, _)
  op(0x68, BIT_o_irr_r, 5, addr, _)
  op(0x69, BIT_o_irr_r, 5, addr, _)
  op(0x6a, BIT_o_irr_r, 5, addr, _)
  op(0x6b, BIT_o_irr_r, 5, addr, _)
  op(0x6c, BIT_o_irr_r, 5, addr, _)
  op(0x6d, BIT_o_irr_r, 5, addr, _)
  op(0x6e, BIT_o_irr_r, 5, addr, _)
  op(0x6f, BIT_o_irr_r, 5, addr, _)
  op(0x70, BIT_o_irr_r, 6, addr, _)
  op(0x71, BIT_o_irr_r, 6, addr, _)
  op(0x72, BIT_o_irr_r, 6, addr, _)
  op(0x73, BIT_o_irr_r, 6, addr, _)
  op(0x74, BIT_o_irr_r, 6, addr, _)
  op(0x75, BIT_o_irr_r, 6, addr, _)
  op(0x76, BIT_o_irr_r, 6, addr, _)
  op(0x77, BIT_o_irr_r, 6, addr, _)
  op(0x78, BIT_o_irr_r, 7, addr, _)
  op(0x79, BIT_o_irr_r, 7, addr, _)
  op(0x7a, BIT_o_irr_r, 7, addr, _)
  op(0x7b, BIT_o_irr_r, 7, addr, _)
  op(0x7c, BIT_o_irr_r, 7, addr, _)
  op(0x7d, BIT_o_irr_r, 7, addr, _)
  op(0x7e, BIT_o_irr_r, 7, addr, _)
  op(0x7f, BIT_o_irr_r, 7, addr, _)
  op(0x80, RES_o_irr_r, 0, addr, B)
  op(0x81, RES_o_irr_r, 0, addr, C)
  op(0x82, RES_o_irr_r, 0, addr, D)
  op(0x83, RES_o_irr_r, 0, addr, E)
  op(0x84, RES_o_irr_r, 0, addr, _H)
  op(0x85, RES_o_irr_r, 0, addr, _L)
  ...
  op(0x8c, RES_o_irr_r, 1, addr, _H)
  op(0x8d, RES_o_irr_r, 1, addr, _L)
  ...
  op(0x94, RES_o_irr_r, 2, addr, _H)
  op(0x95, RES_o_irr_r, 2, addr, _L)
  ...
  op(0x9c, RES_o_irr_r, 3, addr, _H)
  op(0x9d, RES_o_irr_r, 3, addr, _L)
  ...
  op(0xa4, RES_o_irr_r, 4, addr, _H)
  op(0xa5, RES_o_irr_r, 4, addr, _L)
  ...
  op(0xac, RES_o_irr_r, 5, addr, _H)
  op(0xad, RES_o_irr_r, 5, addr, _L)
  ...
  op(0xb4, RES_o_irr_r, 6, addr, _H)
  op(0xb5, RES_o_irr_r, 6, addr, _L)
  ...
  op(0xbc, RES_o_irr_r, 7, addr, _H)
  op(0xbd, RES_o_irr_r, 7, addr, _L)
  ...
  op(0xc4, SET_o_irr_r, 0, addr, _H)
  op(0xc5, SET_o_irr_r, 0, addr, _L)
  ...
  op(0xcc, SET_o_irr_r, 1, addr, _H)
  op(0xcd, SET_o_irr_r, 1, addr, _L)
  ...
  op(0xd4, SET_o_irr_r, 2, addr, _H)
  op(0xd5, SET_o_irr_r, 2, addr, _L)
  ...
  op(0xdc, SET_o_irr_r, 3, addr, _H)
  op(0xdd, SET_o_irr_r, 3, addr, _L)
  ...
  op(0xe4, SET_o_irr_r, 4, addr, _H)
  op(0xe5, SET_o_irr_r, 4, addr, _L)
  ...
  op(0xec, SET_o_irr_r, 5, addr, _H)
  op(0xed, SET_o_irr_r, 5, addr, _L)
  ...
  op(0xf4, SET_o_irr_r, 6, addr, _H)
  op(0xf5, SET_o_irr_r, 6, addr, _L)
  ...
  op(0xfc, SET_o_irr_r, 7, addr, _H)
  op(0xfd, SET_o_irr_r, 7, addr, _L)
