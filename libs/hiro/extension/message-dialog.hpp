...
struct MessageDialog {
  ...
  auto error(const std::vector<string>& buttons = {"Ok"}) -> string;
  auto information(const std::vector<string>& buttons = {"Ok"}) -> string;
  auto question(const std::vector<string>& buttons = {"Yes", "No"}) -> string;
  ...
  auto warning(const std::vector<string>& buttons = {"Ok"}) -> string;
