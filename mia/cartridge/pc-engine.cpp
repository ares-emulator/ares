...
auto PCEngine::load(string location) -> shared_pointer<vfs::directory> {
  vector<u8> rom;
...
auto PCEngine::save(string location, shared_pointer<vfs::directory> pak) -> bool {
...
auto PCEngine::heuristics(vector<u8>& data, string location) -> string {
