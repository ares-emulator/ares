...
Nintendo64::Nintendo64() {
  ...
  { InputDevice device{"Gamepad"};
    ...
    device.digital("Max Output Reducer 1", virtualPorts[id].pad.lstick_max_output_reduce_1);
    device.digital("Max Output Reducer 2", virtualPorts[id].pad.lstick_max_output_reduce_2);
    port.append(device); }
