...
PlayStation::PlayStation() {
  ...
  { InputDevice device{"DualShock"};
    ...
    device.digital("L-Stick Max Output Reducer 1", virtualPorts[id].pad.lstick_max_output_reduce_1);
    device.digital("L-Stick Max Output Reducer 2", virtualPorts[id].pad.lstick_max_output_reduce_2);
    device.digital("R-Stick Max Output Reducer 1", virtualPorts[id].pad.rstick_max_output_reduce_1);
