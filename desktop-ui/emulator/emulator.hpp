struct Emulator {
  ...
  auto setOutputStyle(string value) -> bool;
  auto setMaxOutputReducerOneFactor(f64 value) -> bool;
  auto setMaxOutputReducerTwoFactor(f64 value) -> bool;
  auto setCustomMaxOutput(f64 value) -> bool;
  auto setDeadzoneShape(string value) -> bool;
  ...
  auto setNotchAngularSnappingDistance(f64 value) -> bool;
