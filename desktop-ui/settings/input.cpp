auto InputSettings::construct() -> void {
 ...
 for(auto& emulator : emulators) {
    systemList.append(ComboButtonItem().setText(emulator->name)).setToolTip("The buttons you set for a system will be translated for another equivalent input.\neg. when setting BAYX inputs for the Super Famicom buttons will be translated respectively as Cross, Circle, Square, and Triangle for the Dual Shock controller.");
  }
